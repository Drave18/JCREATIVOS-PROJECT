...
function verifyUser(event){
      ...
      if (email && password) {
        ...
        // si el valor de samePassword es true, con ! se convierte a false y se ejecuta la condicion
        // pero si el valor es false , con ! se convierte a true y no se ejecuta la condicion
